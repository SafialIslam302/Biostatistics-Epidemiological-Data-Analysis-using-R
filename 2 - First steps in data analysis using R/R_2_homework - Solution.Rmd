...
#Solution:
#Goto File -> New File -> R Markdown
#Then convert this file either in html or pdf
...
data <- read_excel("D:/Potsdam/Winter 2021-2021/Biostatistics & Epidemiological Data Analysis using R/2 - First steps in data analysis using R.Exercise 2.xlsx)

#head(data)

data$time_transfar <- as.POSIXct(data$Time, format = "%Y-%m-%d %H:%M:%OS")
